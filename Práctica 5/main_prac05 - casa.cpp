...
void display(void)
{
	...
	//Cabeza
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(1.5, 2.5, 1.0));
	...
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(0.5, 0.5, 1.0));
	...
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(4, 5, 1.0));
	...
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(4, 2, 1.0));
	...
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(1, 3, 1.0));
	...
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(4, 1, 1.0));
	...
	modelTemp = model;
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0, 1, 0.4));
	glDrawArrays(GL_QUADS, 0, 24);
	...
	model = glm::scale(model, glm::vec3(0.3, 0.25, 0.3));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 1.0f, 0.9f));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp2;
	...
	model = modelTemp; //Reseteando posición y escala
