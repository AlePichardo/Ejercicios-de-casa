...
void display(void)
{
	...
	projectionShader.setVec3("lightColor", 5.0f, 5.0f, 5.0f); //Definimos componente de iluminación (luz x material)
	...
	//Electrón 1
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(electron), glm::vec3(0.0f, 1.0f, 0.0f)); //Movimiento de Traslación
	model = glm::translate(model, glm::vec3(6, 0, 0));
	model = glm::rotate(model, glm::radians(electron), glm::vec3(0.0f, 1.0f, 0.0f)); //Movimiento de Rotación
	...
	//Electrón 3
	model = glm::rotate(model, glm::radians(electron), glm::vec3(1.0f, 0.0f, 0.0f)); //Movimiento de Traslación
	...
	//Electrón 5
	model = glm::rotate(model, glm::radians(electron), glm::vec3(0.0f, 0.0f, 1.0f)); //Movimiento de Traslación
	...
	//Electrón 6
	model = glm::rotate(model, glm::radians(electron * 2), glm::vec3(1.0f, 1.0f, 0.0f)); //Movimiento de Traslación
	model = glm::translate(model, glm::vec3(0, 0, 6));
	model = glm::rotate(model, glm::radians(electron), glm::vec3(1.0f, 0.0f, 0.0f)); //Movimiento de Rotación
	model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
	projectionShader.setMat4("model", model);
