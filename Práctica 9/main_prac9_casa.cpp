...
void LoadTextures()
{
	...
	t_bib_f = generateTextures("Texturas/biblio_front.png", 1);
	t_bib_b = generateTextures("Texturas/biblio_back.png", 1);
	t_bib_l = generateTextures("Texturas/biblio_left.png", 1);
	t_bib_r = generateTextures("Texturas/biblio_right.png", 1);
	...
	glBindTexture(GL_TEXTURE_2D, t_bib_f);
	glActiveTexture(GL_TEXTURE4);
	glBindTexture(GL_TEXTURE_2D, t_bib_b);
	glActiveTexture(GL_TEXTURE5);
	glBindTexture(GL_TEXTURE_2D, t_bib_l);
	glActiveTexture(GL_TEXTURE6);
	glBindTexture(GL_TEXTURE_2D, t_bib_r);
...
void display(void)
{
	...
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_diffuse", t_bib_b);			//Trasera
	glDrawArrays(GL_QUADS, 24, 4);
	lightingShader.setInt("material_diffuse", t_bib_f);			//Frontal
	glDrawArrays(GL_QUADS, 28, 4);
	lightingShader.setInt("material_diffuse", t_white);			//Inferior
	glDrawArrays(GL_QUADS, 40, 4);
	lightingShader.setInt("material_diffuse", t_brick);			//Superior
	glDrawArrays(GL_QUADS, 44, 4);
	lightingShader.setInt("material_diffuse", t_bib_l);			//Izquierda
	glDrawArrays(GL_QUADS, 32, 4);
	lightingShader.setInt("material_diffuse", t_bib_r);			//Derecha
